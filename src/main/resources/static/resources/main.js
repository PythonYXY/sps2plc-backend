...
var PatternWizardComponent = /** @class */ (function () {
    function PatternWizardComponent(route, router, projectService, requirementService) {
        ...
        this.delayWithEnd = new _models_specification__WEBPACK_IMPORTED_MODULE_6__["Delay"]('With end', 'delayL = {t1}, delayR = {t2}', 2, 'Delay with end使Scope的左端点成立时间相对原左端点延迟t1个时间单位，并且若原Scope的时间长度大于t2个时间单位，则Scope的右端点成立时间相对原左端点延迟t2个时间单位。');
        this.delayWithoutEnd = new _models_specification__WEBPACK_IMPORTED_MODULE_6__["Delay"]('Without end', 'delayL = {t1}', 1, 'Delay without end使Scope的左端点成立时间相对原左端点延迟t1个时间单位。');
        this.delayOnBothSides = new _models_specification__WEBPACK_IMPORTED_MODULE_6__["Delay"]('On both sides', 'delayL = {t1}, delayRE = {t2}', 2, 'Delay on both sides使Scope的左端点成立时间相对原左端点延迟t1个时间单位，同时使右端点成立时间相对原右端点延迟t2个时间单位。');
        this.scopes = [
            new _models_specification__WEBPACK_IMPORTED_MODULE_6__["Scope"]('Globally', 'Globally', 'Globally对Property的成立Scope无要求。', 0, [this.delayWithEnd, this.delayWithoutEnd]),
            new _models_specification__WEBPACK_IMPORTED_MODULE_6__["Scope"]('After Q', 'After {1}', 'After Q要求Property在Q成立后必须成立。', 1, [this.delayWithoutEnd, this.delayWithEnd]),
            new _models_specification__WEBPACK_IMPORTED_MODULE_6__["Scope"]('After Q until R', 'After {1} until {2}', 'After Q until R要求Property在Q成立之后，在R成立之前的Scope内必须成立。', 2, [this.delayWithEnd, this.delayWithoutEnd, this.delayOnBothSides]),
            new _models_specification__WEBPACK_IMPORTED_MODULE_6__["Scope"]('When Q', 'When {1}', 'When Q要求Property在Q成立时也必须成立。', 1, [this.delayOnBothSides, this.delayWithoutEnd, this.delayWithEnd]),
        ];
        this.properties = [
            new _models_specification__WEBPACK_IMPORTED_MODULE_6__["Property"]('Universality', '{1} is true', 1, 'Universality要求控制对象在Scope内持续成立。'),
            new _models_specification__WEBPACK_IMPORTED_MODULE_6__["Property"]('Absence', '{1} is false', 1, 'Absence要求控制对象在Scope内始终不成立。'),
            new _models_specification__WEBPACK_IMPORTED_MODULE_6__["Property"]('Existence', '{1} exists', 1, 'Existence要求控制对象在Scope的第一个时间点成立一次，在Scope内的其余时间点皆不成立。'),
            new _models_specification__WEBPACK_IMPORTED_MODULE_6__["Property"]('Interlock', '({1} and {2}) is false', 2, 'Interlock要求两个控制对象在Scope内不能同时成立。')
        ];
    ...
    PatternWizardComponent.prototype.createRequirement = function () {
        ...
        var savedReqText = [this.selectedProperty.text]
            ...
            return _this.selectedScope.text + ', ' + (_this.selectedDelay === null ? '' : _this.selectedDelay.text + ', ') + property + '.';
        });
        var observableBatch = [];
