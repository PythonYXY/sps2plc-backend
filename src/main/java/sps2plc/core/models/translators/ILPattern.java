...
public class ILPattern {
    ...
    public ILPattern(Requirement requirement, ScopeCode scopeCode) {
    ...
    public static Map<String, ILPattern> loadPattern(String configuration) {
        Map<String, ILPattern> patterns = new HashMap<>();
        ...
        for (int i = 0; i < jsonArray.length(); ++i) {
            ...
            ILPattern pattern = new ILPattern(requirement, ScopeCode.getScopeCode(obj.getJSONObject("plc")));
