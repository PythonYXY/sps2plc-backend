...
public class RequirementDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        log.info("Preloading " + this.requirementRepository.save(new Requirement("After 砂轮电动机M1启动按钮按下 until (砂轮电动机M1停止按钮按下 or not 电压继电器闭合), 砂轮电动机M1接触器KM1闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("After 砂轮电动机M1启动按钮按下 until (砂轮电动机M1停止按钮按下 or not 电压继电器闭合), delayL = 0, delayR = 30, 砂轮电动机M1接触器KM3闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("After 砂轮电动机M1启动按钮按下 until (砂轮电动机M1停止按钮按下 or not 电压继电器闭合), delayL = 30, 砂轮电动机M1接触器KM2闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("Globally, (砂轮电动机M1接触器KM2闭合 and 砂轮电动机M1接触器KM3闭合) is false.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));

        log.info("Preloading " + this.requirementRepository.save(new Requirement("When (电动机M2高速转换开关打开 and (not 砂轮升降电动机下降接触器闭合 and (not 中间继电器K2闭合 and 电压继电器闭合))), 工作台转动电动机高速接触器闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When (电动机M2低速转换开关打开 and (not 砂轮升降电动机下降接触器闭合 and (not 中间继电器K2闭合 and 电压继电器闭合))), 工作台转动电动机低速接触器闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("Globally, (工作台转动电动机高速接触器闭合 and 工作台转动电动机低速接触器闭合) is false.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        ...
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When (电动机M3进入点动按钮按下 and (not 工作台进入限位行程开关打开 and 电压继电器闭合)), 工作台移动电动机反转接触器闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("Globally, (工作台移动电动机正转接触器闭合 and 工作台移动电动机反转接触器闭合) is false.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));

        log.info("Preloading " + this.requirementRepository.save(new Requirement("When ((not 中间继电器K2闭合 or 砂轮升降电动机手动控制) and ((中间继电器K2闭合 or 中间继电器K1闭合) and (not 电动机M4（正转）上升点动按钮按下 and (not 砂轮升降上限位行程开关打开 and (not 冷却泵电动机接触器闭合 and (not M0.4 and 电压继电器闭合)))))), 砂轮升降电动机上升接触器闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        ...
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When not 电磁吸盘欠电流控制, 中间继电器K2闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
