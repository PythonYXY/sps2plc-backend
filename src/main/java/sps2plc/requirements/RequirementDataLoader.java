...
public class RequirementDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        log.info("Preloading " + this.requirementRepository.save(new Requirement("After 砂轮电动机M1启动按钮按下 until ((砂轮电动机M1停止按钮按下 or 砂轮电动机M1接触器KM2闭合) or not 热继电器闭合), delayL = 0, delayR = 30, 砂轮电动机M1接触器KM3闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("After 砂轮电动机M1启动按钮按下 until ((砂轮电动机M1停止按钮按下 or 砂轮电动机M1接触器KM2闭合) or not 电压继电器闭合), delayL = 30, 砂轮电动机M1接触器KM2闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When 砂轮电动机M1接触器KM3闭合, 砂轮电动机M1接触器KM2闭合 is false.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When (not 中间继电器K2闭合 and (not 砂轮升降电动机下降接触器闭合 and (电动机M2高速转换开关打开 and (not 工作台转动电动机低速接触器闭合 and 电压继电器闭合)))), 工作台转动电动机高速接触器闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When (not 中间继电器K2闭合 and (not 砂轮升降电动机下降接触器闭合 and (电动机M2低速转换开关打开 and (not 工作台转动电动机高速接触器闭合 and 电压继电器闭合)))), 工作台转动电动机低速接触器闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When (电动机M3退出点动按钮按下 and (not 工作台退出限位行程开关打开 and (not 工作台移动电动机反转接触器闭合 and 电压继电器闭合))), 工作台移动电动机正转接触器闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When (电动机M3进入点动按钮按下 and (not 工作台进入限位行程开关打开 and (not 工作台移动电动机正转接触器闭合 and 电压继电器闭合))), 工作台移动电动机反转接触器闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When ((not 中间继电器K2闭合 or 砂轮升降电动机手动控制) and ((中间继电器K2闭合 or 中间继电器K1闭合) and (not 电动机M4（正转）上升点动按钮按下 and (not 砂轮升降上限位行程开关打开 and (not 电动机M2低速转换开关打开 and not 电磁吸盘充磁可调控制))))), 砂轮升降电动机上升接触器闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When (冷却泵电动机控制 and 电压继电器闭合), 冷却泵电动机接触器闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When 砂轮升降电动机上升接触器闭合, 砂轮升降电动机下降接触器闭合 is false.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When 自动进给电动机接触器闭合, 砂轮升降电动机下降接触器闭合 is false.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When 工作台转动电动机低速接触器闭合, 砂轮升降电动机下降接触器闭合 is false.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When 工作台转动电动机高速接触器闭合, 砂轮升降电动机下降接触器闭合 is false.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("When (冷却泵电动机控制 and 电压继电器闭合), 砂轮升降电动机下降接触器闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("After (自动进给控制 and 自动进给启动按钮按下) until (砂轮升降电动机上升接触器闭合 or (M0.0 or not 电压继电器闭合)), 自动进给电动机接触器闭合 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("After (中间继电器K2闭合 or (自动进给限位行程开关打开 or 自动进给停止按钮按下)) until (not 自动进给电动机接触器闭合 or not 电压继电器闭合), delayL = 10, M0.0 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
        log.info("Preloading " + this.requirementRepository.save(new Requirement("After (中间继电器K2闭合 or (自动进给限位行程开关打开 or 自动进给停止按钮按下)) until (not 自动进给电动机接触器闭合 or not 中间继电器K1闭合), 自动进给控制电磁铁 is true.",
                Long.parseLong("3"), "", Requirement.ReqState.COMPLIANT, false)));
