...
insert into requirement (text, project, error_description, state, disabled) values (
    'After 启动按钮按下 until (停止按钮按下 or 过载保护启动), it is always the case that 电动机启动 holds.',
    1,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'After 停止按钮按下, it is always the case that 制动开关打开 holds within 30 timeUnits.',
    1,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'Globally, it is never the case that (电动机启动 and 制动开关打开) hold.',
    1,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When (报警启动 and not M0.0), it is always the case that M0.1 holds after 5 timeUnits.',
    2,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When (报警启动 and not M0.0), it is always the case that M0.0 holds after 10 timeUnits.',
    2,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When M0.1, it is always the case that 报警灯亮 holds.',
    2,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'After 响应按钮按下 until not 报警启动, it is always the case that 报警灯亮 holds.',
    2,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When 测试按钮按下, it is always the case that 报警灯亮 holds.',
    2,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When 报警启动, it is always the case that 蜂鸣器报警 holds.',
    2,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'After 响应按钮按下 until not 报警启动, it is never the case that 蜂鸣器报警 holds.',
    2,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'After 总启动按钮按下 until (总停止按钮按下 or not 热继电器闭合), it is always the case that 电压继电器闭合 holds.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'After 砂轮电动机M1启动按钮按下 until (砂轮电动机M1停止按钮按下 or not 电压继电器闭合), it is always the case that 砂轮电动机M1接触器KM1闭合 holds.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'After 砂轮电动机M1启动按钮按下 until (砂轮电动机M1停止按钮按下 or not 电压继电器闭合), it is always the case that 砂轮电动机M1接触器KM3闭合 holds within 30 timeUnits.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'After 砂轮电动机M1启动按钮按下 until (砂轮电动机M1停止按钮按下 or not 电压继电器闭合), it is always the case that 砂轮电动机M1接触器KM2闭合 holds after 30 timeUnits.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'Globally, it is never the case that (砂轮电动机M1接触器KM2闭合 and 砂轮电动机M1接触器KM3闭合) hold.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When (电动机M2高速转换开关打开 and (not 砂轮升降电动机下降接触器闭合 and (not 中间继电器K2闭合 and 电压继电器闭合))), it is always the case that 工作台转动电动机高速接触器闭合 holds.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When (电动机M2低速转换开关打开 and (not 砂轮升降电动机下降接触器闭合 and (not 中间继电器K2闭合 and 电压继电器闭合))), it is always the case that 工作台转动电动机低速接触器闭合 holds.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'Globally, it is never the case that (工作台转动电动机高速接触器闭合 and 工作台转动电动机低速接触器闭合) hold.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When (电动机M3退出点动按钮按下 and (not 工作台退出限位行程开关打开 and 电压继电器闭合)), it is always the case that 工作台移动电动机正转接触器闭合 holds.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When (电动机M3进入点动按钮按下 and (not 工作台进入限位行程开关打开 and 电压继电器闭合)), it is always the case that 工作台移动电动机反转接触器闭合 holds.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'Globally, it is never the case that (工作台移动电动机正转接触器闭合 and 工作台移动电动机反转接触器闭合) hold.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When ((not 中间继电器K2闭合 or 砂轮升降电动机手动控制) and ((中间继电器K2闭合 or 中间继电器K1闭合) and (not 电动机M4（正转）上升点动按钮按下 and (not 砂轮升降上限位行程开关打开 and (not 冷却泵电动机接触器闭合 and (not M0.4 and 电压继电器闭合)))))), it is always the case that 砂轮升降电动机上升接触器闭合 holds.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When (电动机M4（反转）下降点动按钮按下 and (not 自动进给电动机接触器闭合 and (not 砂轮升降电动机上升接触器闭合 and (not 工作台转动电动机低速接触器闭合 and (not 工作台转动电动机高速接触器闭合 and 电压继电器闭合))))), it is always the case that 砂轮升降电动机上升接触器闭合 holds.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When (冷却泵电动机控制 and 电压继电器闭合), it is always the case that 冷却泵电动机接触器闭合 holds.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'After (总启动按钮按下 and 自动进给启动按钮按下) until (中间继电器K2闭合 or (自动进给限位行程开关打开 or 自动进给停止按钮按下)), it is always the case that 自动进给电动机接触器闭合 holds and the property still holds for 10 timeUnits after the end of the scope.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'After (总启动按钮按下 and 自动进给启动按钮按下) until (中间继电器K2闭合 or (自动进给限位行程开关打开 or 自动进给停止按钮按下)), it is always the case that 自动进给控制电磁铁 holds and the property still holds for 10 timeUnits after the end of the scope.
',
    3,
    '',
    'COMPLIANT',
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When (not 电压继电器闭合 or 砂轮升降电动机上升接触器闭合), it is never the case that 自动进给电动机接触器闭合 holds.',
    3,
    '',
    'COMPLIANT',
    true
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When (not 电压继电器闭合 or 砂轮升降电动机上升接触器闭合), it is never the case that 自动进给控制电磁铁 holds.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When not 电磁吸盘欠电流控制,  it is always the case that 中间继电器K2闭合 holds.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When 电磁吸盘充磁可调控制, it is always the case that 电磁吸盘控制接触器闭合 holds.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When 电磁吸盘控制接触器闭合, it is always the case that 中间继电器K1闭合 holds.',
    3,
    '',
    'COMPLIANT',
    false
...
insert into requirement (text, project, error_description, state, disabled) values (
    'When not 电磁吸盘控制接触器闭合, it is always the case that 中间继电器K3闭合 holds.',
    3,
    '',
    'COMPLIANT',
    false
